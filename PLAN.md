...
2. ✅ Create Firecrawl scraping function for initial quotes
3. ✅ Seed database with 50+ curated quotes
...
### Tasks:
1. ✅ Integrate Cloudflare AI for quote embeddings (BGE-base-en-v1.5)
2. ✅ Implement semantic similarity search with cosine similarity
3. ✅ Add personalized recommendations based on journey history
4. ✅ Create AI-generated insights for each quote (Llama 3)
5. ✅ Track user preferences and favorites

**Success Criteria**: ✅ All met
- AI embeddings working with Cloudflare AI ✅
- Semantic search finds related quotes by meaning ✅
- AI insights displayed on journey page ✅
